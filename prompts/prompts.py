...
all_prompts = {
    ...
    "caltech101": {
        "classes" : [
            #['Internet Meme', 'background', 'low resolution', 'text'],
            'human face',
            'ID photo',
            'leopard',
            'motorbike',
    ...
    "office_ar":{
        "classes":['Drill', 'Exit Sign', 'Bottle', 'Glasses', 'Computer', 'File Cabinet', 'Shelf', 'Toys', 'Sink',
               'Laptop', 'Kettle', 'Folder', 'Keyboard', 'Flipflops', 'Pencil', 'Bed', 'Hammer', 'ToothBrush', 'Couch',
               'Bike', 'Postit Notes', 'Mug', 'Webcam', 'Desk Lamp', 'Telephone', 'Helmet', 'Mouse', 'Pen', 'Monitor',
               'Mop', 'Sneakers', 'Notebook', 'Backpack', 'Alarm Clock', 'Push Pin', 'Paper Clip', 'Batteries', 'Radio',
               'Fan', 'Ruler', 'Pan', 'Screwdriver', 'Trash Can', 'Printer', 'Speaker', 'Eraser', 'Bucket', 'Chair',
               'Calendar', 'Calculator', 'Flowers', 'Lamp Shade', 'Spoon', 'Candles', 'Clipboards', 'Scissors', 'TV',
...
with open('clip_prompts','w') as filename:
    json.dump(all_prompts, filename)